...
In the final Streamlit app, when a judge, county, and case-type are selected, the model will provide and plot the relative liklihood of a summary judgment motion being affirmed, as illustrated below:
